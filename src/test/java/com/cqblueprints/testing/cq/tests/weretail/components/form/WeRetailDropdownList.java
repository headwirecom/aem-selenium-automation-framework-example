...
public class WeRetailDropdownList extends RetailBaseTest {
	public static final String COMPONENT_NAME = "Dropdown List";
	public static final String COMPONENT_CRX_NAME = "dropdown";
	...
	public void testDropdownValues() throws Exception {
		...
		String elementName = "dropdown-elem-name";
		...
		for (String val : dropdownValues) {
			authorPage.assertExists(By.xpath("//select/option[@value='"+val+"']"));
		}
	}
