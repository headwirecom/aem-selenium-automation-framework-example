...
public class GeneralTableTest extends DefaultComponentBase {
	public static final String COMPONENT_CRX_NAME = "table";
	...
	public void placeComponent() throws Exception {
		...
		authorPage.dragComponentIntoParsys("Table", "par");
	}
